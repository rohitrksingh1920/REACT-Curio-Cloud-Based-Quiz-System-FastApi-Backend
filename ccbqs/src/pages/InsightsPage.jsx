...
//       <p className="weak-card-msg">{topic.message}</p>
//       <div className="progress-bar" style={{ marginTop: 10 }}>
//         <div className="progress-fill" style={{ width: `${topic.accuracy}%`, background: cfg.color }} />
//       </div>
//     </div>
//   )
// }
...
//       fontSize: 14, color: c.color, fontWeight: 500, lineHeight: 1.5,
//     }}>
//       {msg}
//     </div>
//   )
...
//       .then(d  => { if (!cancelled) setData(d) })
//       .catch(() => {
//         // On any error, set empty data — never show red error banner
...
//   const radarData = (data?.topic_profile || []).map(t => ({
//     subject: t.category.replace('Computer Science', 'CS'),
//     mastery: t.mastery, fullMark: 100,
//   }))

//   const hasData = (data?.topic_profile?.length || 0) > 0
...
//           </div>
//           <h3 style={{ fontSize: 20, marginBottom: 10 }}>No insights yet</h3>
//           <p style={{ color: 'var(--text-2)', maxWidth: 400, margin: '0 auto 24px', fontSize: 14, lineHeight: 1.6 }}>
//             Complete at least one quiz to see your personalised ML insights,
//             weak topic detection, and skill radar chart.
//           </p>
//           <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
//             <a href="/my-quizzes" className="btn btn-primary">
...
//           {(data?.improvement_messages?.length || 0) > 0 && (
//             <div className="card insights-section mb-6">
//               <h3 className="insights-section-title">
//                 <i className="ri-lightbulb-flash-line" /> Personalised Insights
//               </h3>
...
//                           fontWeight: 700,
//                           color: t.improvement > 0 ? 'var(--success)'
//                             : t.improvement < 0 ? 'var(--danger)' : 'var(--text-3)',
//                         }}>
//                           {t.improvement > 0 ? '+' : ''}{t.improvement?.toFixed(1)}%
//                         </span>
//                         <span style={{ fontWeight: 700, color: SUBJECT_COLORS[i % SUBJECT_COLORS.length] }}>
