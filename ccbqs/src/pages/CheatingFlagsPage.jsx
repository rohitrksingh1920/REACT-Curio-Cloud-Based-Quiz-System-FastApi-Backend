...
//         <div style={{ fontSize: 11, color: 'var(--text-3)' }}>User #{flag.user_id}</div>
//       </td>
//       <td style={{ fontSize: 13, color: 'var(--text-2)', maxWidth: 200 }}>{flag.quiz_title}</td>
//       <td>
//         <span style={{
//           background: sev.bg, color: sev.color,
//           padding: '3px 10px', borderRadius: 99,
...
//         }}>{sev.label}</span>
//       </td>
//       <td style={{ fontSize: 12, color: 'var(--text-2)', maxWidth: 240 }}>{flag.detail || '—'}</td>
//       <td style={{ fontSize: 12, color: 'var(--text-3)' }}>{formatIST(flag.created_at)}</td>
//       <td>
//         {flag.is_reviewed ? (
//           <span style={{ fontSize: 12, color: 'var(--success)', display: 'flex', alignItems: 'center', gap: 4 }}>
//             <i className="ri-checkbox-circle-line" /> Reviewed
...
//       setFlags(Array.isArray(data) ? data : [])
//     } catch {
//       setFlags([])  // Never show error — just show empty
//     } finally {
//       setLoading(false)
//     }
//   }
...
//         ) : flags.length === 0 ? (
//           <div className="empty-state">
//             <i className="ri-shield-check-line" style={{ color: 'var(--success)', fontSize: 48 }} />
//             <h3>No flags found</h3>
//             <p>
//               {reviewed === null
//                 ? 'No suspicious behavior has been detected yet. Flags appear automatically when students submit quizzes with unusual patterns.'
...
//               <thead>
//                 <tr>
//                   <th>Type</th><th>User</th><th>Quiz</th>
//                   <th>Severity</th><th>Detail</th>
//                   <th>Detected (IST)</th><th>Status</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {flags.map(f => (
