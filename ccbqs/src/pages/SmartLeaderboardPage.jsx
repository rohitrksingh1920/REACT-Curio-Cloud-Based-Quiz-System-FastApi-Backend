...
// function ScoreBar({ value, color = 'var(--primary)', label }) {
//   return (
//     <div style={{ flex: 1, minWidth: 60 }}>
//       <div style={{ fontSize: 11, color: 'var(--text-3)', marginBottom: 3 }}>{label}</div>
//       <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
...
//   useEffect(() => {
//     QuizAPI.list().then(d => {
//       setQuizList(Array.isArray(d) ? d : d?.quizzes || [])
//     }).catch(() => {})
//   }, [])

//   // Load smart leaderboard when quiz selected
//   useEffect(() => {
...
//       .then(d => setData(d))
//       .catch(() => setData({
//         quiz_id: selected, quiz_title: 'Quiz',
//         total_participants: 0, entries: [],
...
//     setSelected(val)
//     if (val) navigate(`/smart-leaderboard/${val}`)
//     else navigate('/smart-leaderboard')
//   }

//   return (
//     <AppShell title="Smart Leaderboard"
//       subtitle="ML-powered composite ranking — score, consistency & improvement">
...
//           <i className="ri-trophy-line" style={{ fontSize: 20, color: 'var(--primary)' }} />
//           <label style={{ fontSize: 14, fontWeight: 600, whiteSpace: 'nowrap' }}>Select Quiz:</label>
//           <select value={selected} onChange={handleQuizChange} style={{ maxWidth: 360 }}>
//             <option value="">— Choose a quiz —</option>
//             {quizList.map(q => <option key={q.id} value={q.id}>{q.title}</option>)}
//           </select>
//           {selected && (
...
//       {/* No attempts yet */}
//       {selected && !loading && data?.total_participants === 0 && (
//         <>
//           <div className="slb-formula-banner mb-6">
//             <i className="ri-functions" />
//             <span>
...
//               <h3>No attempts yet</h3>
//               <p>
//                 No one has completed this quiz yet. Once students submit their answers,
//                 composite scores will appear here.
//               </p>
//               <a href="/my-quizzes" className="btn btn-primary" style={{ marginTop: 16 }}>
//                 <i className="ri-play-line" /> Take a Quiz
//               </a>
//             </div>
//           </div>
//         </>
...
//       {/* Leaderboard entries */}
//       {selected && !loading && (data?.total_participants || 0) > 0 && (
//         <>
//           {viewMode === 'smart' && (
//             <div className="slb-formula-banner mb-6">
//               <i className="ri-functions" />
