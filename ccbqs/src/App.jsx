...
import MyQuizzes       from './pages/MyQuizzesPage'
import CreateQuiz      from './pages/CreateQuizPage'
import TakeQuiz        from './pages/TakeQuizPage'       // ML-enhanced version
import Analytics       from './pages/AnalyticsPage'
import Leaderboard     from './pages/LeaderboardPage'
import Notifications   from './pages/NotificationsPage'
import Settings        from './pages/SettingsPage'
...
import SmartLeaderboardPage  from './pages/SmartLeaderboardPage'
import CheatingFlagsPage     from './pages/CheatingFlagsPage'
...
function AppRoutes() {
  return (
    <Routes>
      ...
      {/* ── NEW ML routes — all users ────────────────────────────────────── */}
      <Route path="/insights"                  element={<ProtectedRoute><InsightsPage /></ProtectedRoute>} />
      <Route path="/smart-leaderboard/:id"     element={<ProtectedRoute><SmartLeaderboardPage /></ProtectedRoute>} />
      <Route path="/smart-leaderboard"         element={<ProtectedRoute><SmartLeaderboardPage /></ProtectedRoute>} />
      ...
      <Route path="/admin"           element={<ProtectedRoute adminOnly><AdminPage /></ProtectedRoute>} />
      <Route path="/admin/cheating"  element={<ProtectedRoute adminOnly><CheatingFlagsPage /></ProtectedRoute>} />
